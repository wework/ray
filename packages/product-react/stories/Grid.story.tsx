    ...
    return (
      <>
        ...
        <Container debug={true}>
          ...
          <hr />
          <Grid>
            <Grid.Cell align="top">Align top</Grid.Cell>
            <Grid.Cell align="middle">Align middle</Grid.Cell>
            <Grid.Cell align="bottom">Align bottom</Grid.Cell>
          </Grid>
          <hr />
          <Grid>
          ...
          <Grid>
            ...
            <Grid.Cell pushColumn={6} device="tablet">
              Push Tablet
            </Grid.Cell>
            <Grid.Cell pushColumn={12} device="phone">
              Push Phone
            </Grid.Cell>
          </Grid>
        </Container>
